...
import org.codeforiraq.autheticationcrud.Controller.Adapteruser;
import org.codeforiraq.autheticationcrud.Controller.Adapteruser;
...
public class viewSearch extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        vioList = getData();
        adapter = new Adapteruser( this,vioList);
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                finish();
                Intent intent = new Intent(viewSearch.this, ViewAdmin.class);
...
//                        .setAction("Action", null).show();
    ...
    public List<Violation> getData(){
        ...
        JsonObjectRequest jsonObjectRequest = new JsonObjectRequest( Request.Method.GET,
                URLs.search+value, null, new Response.Listener<JSONObject>() {
