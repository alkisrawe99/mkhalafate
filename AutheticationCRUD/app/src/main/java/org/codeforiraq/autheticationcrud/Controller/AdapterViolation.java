...
public class AdapterViolation  extends RecyclerView.Adapter<AdapterViolation.MyViewHolder> {

    private Context context;
    private List<Violation> vioList;

    public AdapterViolation(Context context, List<Violation> vioList) {
    ...
    @NonNull
    @Override
    public AdapterViolation.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull AdapterViolation.MyViewHolder holder, final int position) {
        ...
        holder.edit.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(context, Editviolation.class);
                intent.putExtra("id",vio.getId());
                intent.putExtra("name_of_driver",vio.getName_driver());
                intent.putExtra("car_name", vio.getNam_car());
                intent.putExtra("car_num", vio.getNum_car());
                intent.putExtra("location", vio.getLocation());
                intent.putExtra("price",vio.getPrice());
                intent.putExtra("name_vio",vio.getName_vio());
