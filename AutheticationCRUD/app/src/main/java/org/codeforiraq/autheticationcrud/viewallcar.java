...
import org.codeforiraq.autheticationcrud.Controller.AdapterCar;
...
public class viewallcar extends AppCompatActivity {

    private Context context;
    private RecyclerView recyclerView;
    public static AdapterCar adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        carList = getData();
        adapter = new AdapterCar( this,carList);
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(viewallcar.this, ViewAdmin.class);
    ...
    public List<Car> getData(){
        ...
        JsonObjectRequest jsonObjectRequest = new JsonObjectRequest( Request.Method.GET,
                URLs.view_car, null, new Response.Listener<JSONObject>() {

            @Override
            public void onResponse(JSONObject response) {
                try {

                    JSONArray bookArray = response.getJSONArray("car");

                    for (int i = 0; i < bookArray.length(); i++) {
                        JSONObject userObj = bookArray.getJSONObject(i);
                        Car user = new Car();
                        user.setId(userObj.getInt("id"));
                        user.setCar_name(userObj.getString("car_name"));
                       user.setCar_num(userObj.getString("car_num"));
